...
node {
  ...
  output_stream: "TENSORS:detection_image_tensor"
}
...
node {
  ...
  input_stream: "TENSORS:detection_image_tensor"
...
node: {
  ...
  output_stream: "IMAGE:transformed_hand_image"
  output_stream: "LETTERBOX_PADDING:landmark_letterbox_padding"
  node_options: {
    [type.googleapis.com/mediapipe.ImageTransformationCalculatorOptions] {
      output_width: 256
      output_height: 256
...
node {
  calculator: "TfLiteConverterCalculator"
  input_stream: "IMAGE:transformed_hand_image"
  output_stream: "TENSORS:tracking_image_tensor"
}
...
node {
  calculator: "TfLiteInferenceCalculator"
  input_stream: "TENSORS:tracking_image_tensor"
...
node {
  ...
  input_stream: "LETTERBOX_PADDING:landmark_letterbox_padding"
